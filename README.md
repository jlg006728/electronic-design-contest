...
- `20260717_功能更新总结.md` - 按功能模块汇总这次仓库更新，包含循迹、瞄准、供电和当前可用状态

### 2026-07-09 当前视觉定位方案

OpenMV 视觉定位已从红色圆环颜色识别切换为 **黑色外框中心检测**。当前可用脚本为：

- `ccs_project/openmv_test/20260709_black_frame_uart_stream_watchdog.py`
- 队员说明：`ccs_project/openmv_test/20260709_black_frame_uart_stream_watchdog_readme.md`

该版保留原 UART 17 字节目标帧协议、主动上报、watchdog 和异常自恢复，只把 `cx/cy` 的来源从红色目标中心替换为黑框四角平均中心。
