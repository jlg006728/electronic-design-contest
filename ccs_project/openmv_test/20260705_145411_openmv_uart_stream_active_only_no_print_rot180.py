...
#   3. Use a shorter stream interval and prefer the largest red blob more
#      strongly, so fast target motion is less likely to be dropped.
# 20260705_145411 version:
#   4. Always run the camera/stream loop. UART RX is drained but never allowed
#      to skip a vision frame.
#   5. Disable periodic prints for standalone power tests without USB.
#
# Standalone test:
...
if ENABLE_DEBUG_PRINT:
    print("OpenMV UART fast stream ready: UART3=115200, QVGA RGB565, rot180=1")
