...
# 20260707_144221:
#   Stable QVGA far-target version.
#   1. Keep QVGA to avoid VGA frame-rate/memory pressure.
#   2. Broaden red thresholds moderately for farther targets.
#   3. Reduce target-size gates, but keep width/height/density filters.
#   4. Reduce center penalty so off-center distant target can still win.
#
# 20260705_145746:
...
# The second range is a moderate far-target range; do not make it too wide
# unless checked in the OpenMV threshold editor.
RED_THRESHOLDS = [
    (20, 80, 20, 90, 10, 80),
    (14, 90, 16, 100, -2, 90),
]
