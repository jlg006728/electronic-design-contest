 ...
 *   Servo HOME recalibration build. OpenMV tracking is disabled.
 *
 * Wiring:
...
#define SERVO_CALIBRATION_MODE         1U
...
volatile uint8_t g_servo_calibrate_enable = SERVO_CALIBRATION_MODE;
...
{
    /* Calibration build: allow a wider range, but keep pulse widths meaningful. */
