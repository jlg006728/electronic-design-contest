/**
 * Strong straight balance closed-loop test - MSPM0G3507 LaunchPad
 *
 * Use this after the basic straight_balance_closed_loop.c saturates.
 * Wheels must be suspended in the air.
 */
