/**
 * Soft straight balance closed-loop test - MSPM0G3507 LaunchPad
 *
 * This is the safer tuning version after fixed PWM polarity is confirmed.
 * It uses gentler proportional correction to avoid oscillation.
 */
...
#define PWM_BASE_TICKS      850U
#define PWM_MIN_TICKS       520U
#define PWM_MAX_TICKS       1180U
...
static void balance_update(void)
{
    ...
    g_pwm_correction = g_balance_error / 16;
