/**
 * Pre-sharp-turn line-following test.
 *
 * Status:
 *   Reconstructed from the version before adding the right-angle/sharp-turn
 *   strategy. Round corners and S curves were usable; right-angle turns could
 *   still run out of the line.
 *
 ...
 *   LINE_KP_DIVISOR = 20
 *   LINE_CORR_LIMIT = 150
 *   No sharp-turn branch is enabled in this file.
 */
...
#define RUN_SAMPLES             600U
#define LOST_STOP_SAMPLES       100U
