/*
 * V56 MSPM0G3507 + YB-MYX05-V1.0 midpoint-speed line-follow test.
 *
 * Wiring:
...
#define PWM_LEFT_BASE_TICKS              480U
#define PWM_RIGHT_BASE_TICKS             465U
#define PWM_MIN_TICKS                    295U
#define PWM_MAX_TICKS                    705U
#define START_BOOST_LEFT_TICKS           620U
#define START_BOOST_RIGHT_TICKS          600U
#define START_BOOST_FRAMES               20U
#define LINE_KP_DIVISOR                  22
#define LINE_CORR_LIMIT                  130
#define LINE_SHARP_ERROR                 1800
#define LINE_SHARP_KP_DIVISOR            8
#define LINE_SHARP_CORR_LIMIT            340
