/**
 * 7-channel TCRT5000 read test with remapped first three sensors.
 *
 * Use this when PA2/PA5/PA6 are suspected damaged or unavailable.
 *
 ...
 *
 * Watch:
 *   g_s1, g_s2, g_s3, g_s4, g_s5, g_s6, g_s7, g_line_raw_mask
 */
...
static void read_line_sensors(void)
{
    ...
    g_s1 = ((b & S1_PIN) != 0U) ? 1U : 0U;
    g_s2 = ((b & S2_PIN) != 0U) ? 1U : 0U;
    g_s3 = ((b & S3_PIN) != 0U) ? 1U : 0U;
