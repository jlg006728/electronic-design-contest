...
static NOINLINE void start_gap_bridge_update(void)
{
    ...
    set_pwm(
        clamp_pwm((int32_t) START_GAP_LEFT_BASE_TICKS - g_start_gap_correction),
        clamp_pwm((int32_t) START_GAP_RIGHT_BASE_TICKS + g_start_gap_correction));
...
int main(void)
{
    ...
    if ((START_GAP_BRIDGE_ENABLE != 0U) && (g_line_valid == 0U)) {
        g_turn_mode = 4U;
        g_line_correction = 0;
        set_pwm(START_GAP_LEFT_BASE_TICKS, START_GAP_RIGHT_BASE_TICKS);
