/**
 * V36 slower motor-enabled line follow with bridge left-drift fix.
 *
 * Goal:
...
#define PWM_LEFT_BASE_TICKS         540U
#define PWM_RIGHT_BASE_TICKS        515U
#define PWM_MIN_TICKS               380U
#define PWM_MAX_TICKS               760U

#define START_GAP_LEFT_TICKS        560U
#define START_GAP_RIGHT_TICKS       500U
