...
#define START_BRIDGE_LEFT_CORR_LIMIT     65
#define START_BRIDGE_RIGHT_CORR_LIMIT    24
#define START_BRIDGE_RIGHT_CONFIRM_FRAMES 3U
#define START_BRIDGE_LEFT_SLEW_TICKS     6
