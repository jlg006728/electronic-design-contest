/**
 * V31 stable chassis rescue.
 *
 * Goal:
 *   Restore the verified low-level chassis behavior before re-adding OpenMV,
 *   mission points, and encoder-distance tasks.
 *
 * This version tests only:
 *   - 7 digital line sensors
 *   - TB6612 motor output
 *   - A-start no-line bridge
 *   - immediate transition to line following when any sensor sees black
...
#define START_GAP_LEFT_TICKS        PWM_LEFT_BASE_TICKS
#define START_GAP_RIGHT_TICKS       PWM_RIGHT_BASE_TICKS
