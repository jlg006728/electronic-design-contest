/*
 * V90: minimal eight-channel grayscale line follower.
 *
 * Wiring:
...
#define PWM_LEFT_BASE_TICKS         380
#define PWM_RIGHT_BASE_TICKS        383
#define PWM_MIN_TICKS               250
#define PWM_MAX_TICKS               657

#define LINE_KP_DIVISOR             36
#define LINE_CORRECTION_LIMIT       70
#define LINE_LOST_SEARCH_TICKS      70
#define LINE_LOST_TIMEOUT_FRAMES    200U
...
static const simple_line_config_t LINE_CONTROL_CONFIG = {
    ...
    .pwm_min = PWM_MIN_TICKS,
    .pwm_max = PWM_MAX_TICKS,
    .kp_divisor = LINE_KP_DIVISOR,
    .correction_limit = LINE_CORRECTION_LIMIT,
    .lost_search_correction = LINE_LOST_SEARCH_TICKS,
    .lost_timeout_frames = LINE_LOST_TIMEOUT_FRAMES,
};
