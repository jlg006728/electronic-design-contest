/**
 * V45 encoder PI bridge, quiet sensor sample, stronger line turn.
 *
 * Scope:
 *   - Chassis/line-following test only, no ABCD mission logic.
 *   - White surface = sensor high/1/light on; black line = low/0/light off.
 *   - Bridge stage uses encoder speed-difference P and distance-difference I.
...
#define START_GAP_ENCODER_DELTA_KP_DIV 2
#define START_GAP_ENCODER_DISTANCE_KI_DIV 64
#define START_GAP_ENCODER_LIMIT     95
#define START_GAP_ENCODER_SLEW_LIMIT 18
...
static NOINLINE void start_gap_bridge_update(void)
{
    ...
    g_start_gap_encoder_speed_term =
        g_start_gap_encoder_delta_diff / START_GAP_ENCODER_DELTA_KP_DIV;
    g_start_gap_encoder_distance_term =
        g_encoder_diff_forward_total / START_GAP_ENCODER_DISTANCE_KI_DIV;

    target_correction = clamp_int32(
        g_start_gap_encoder_speed_term + g_start_gap_encoder_distance_term,
