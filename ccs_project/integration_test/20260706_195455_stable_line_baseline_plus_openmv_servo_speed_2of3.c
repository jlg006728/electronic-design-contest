...
#define PWM_LEFT_BASE_TICKS         413U
#define PWM_RIGHT_BASE_TICKS        393U
#define PWM_LEFT_BOOST_TICKS        413U
#define PWM_RIGHT_BOOST_TICKS       393U
#define PWM_MIN_TICKS               287U
#define PWM_MAX_TICKS               567U
#define PWM_SHARP_LEFT_BASE_TICKS   413U
#define PWM_SHARP_RIGHT_BASE_TICKS  393U
