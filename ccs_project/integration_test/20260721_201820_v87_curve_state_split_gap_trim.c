/*
 * V87 MSPM0G3507 + right-curve state control and split gap trim.
 *
 * Wiring:
...
#define START_BOOST_TRIM_TICKS           (-6)
#define START_BOOST_FRAMES               40U
#define START_BRIDGE_BASE_TICKS          427
#define START_BRIDGE_TRIM_TICKS          (-10)
