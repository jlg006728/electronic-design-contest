/*
 * V88 MSPM0G3507 + topology-gated gaps and predictive curve capture.
 *
 * Wiring:
 *   PB5 -> AD0, PB6 -> AD1, PB7 -> AD2, PA7 <- OUT.
 *
 * Scope:
 *   The grayscale array and TB6612 motors are active. The MPU is disabled.
...
#define DRIVE_CONTEXT_START_BRIDGE       0U
#define DRIVE_CONTEXT_LINE_CURVE         1U
#define DRIVE_CONTEXT_POST_CURVE_GAP     2U

#define CURVE_CONTROL_IDLE               0U
#define CURVE_CONTROL_CAPTURE            1U
#define CURVE_CONTROL_TRACK              2U
#define CURVE_CONTROL_INNER_RECOVERY     3U
...
#define PWM_LEFT_BASE_TICKS              380U
#define PWM_RIGHT_BASE_TICKS             383U
#define PWM_MIN_TICKS                    250U
#define PWM_MAX_TICKS                    657U
#define START_BOOST_BASE_TICKS           560
#define START_BOOST_TRIM_TICKS           0
#define START_BOOST_FRAMES               40U
#define START_BRIDGE_BASE_TICKS          427
#define START_BRIDGE_TRIM_TICKS          0
#define POST_CURVE_LEFT_TICKS            380U
#define POST_CURVE_RIGHT_TICKS           383U
...
#define LINE_SHARP_CORR_LIMIT            300
#define LINE_CENTER_MASK                 0x18U
#define LINE_CENTER_ERROR_MAX            600
#define LINE_CENTER_CONFIRM_FRAMES       4U
#define LINE_LOST_STRONG_FRAMES          20U
#define LINE_LOST_MEDIUM_FRAMES          50U
...
#define START_BRIDGE_MAX_FRAMES          500U
#define LINE_LOST_MAX_FRAMES             200U
...
#define TURN_EXIT_HOLD_FRAMES            56U
...
#define TURN_EXIT_CONFIRM_LOST_FRAMES    3U
#define TURN_EXIT_BRAKE_CORR_TICKS       0
#define TURN_EXIT_BRAKE_MIN_FRAMES       6U
#define TURN_EXIT_BRAKE_MAX_FRAMES       30U
#define TURN_EXIT_BRAKE_NO_MPU_FRAMES    16U
#define TURN_EXIT_BRAKE_STOP_RATE_MDPS   3000
#define TURN_EXIT_BRAKE_START_RATE_MDPS  1000
#define TURN_EXIT_DYNAMIC_COUNTER_DIVISOR 8
#define TURN_EXIT_DYNAMIC_COUNTER_LIMIT  18
#define TURN_EXIT_LEFT_NUDGE_ENABLE      0U
#define TURN_EXIT_LEFT_NUDGE_TICKS       10
#define TURN_EXIT_LEFT_NUDGE_FRAMES      8U

#define CURVE_RIGHT_FEEDFORWARD_TICKS    12
#define CURVE_FEEDFORWARD_STEP_TICKS     2
#define CURVE_RIGHT_RECOVERY_ERROR_MIN   500
#define CURVE_RIGHT_RECOVERY_DIVISOR     10
#define CURVE_RIGHT_RECOVERY_CORR_LIMIT  80
#define CURVE_RIGHT_LOST_HOLD_MAX_CORR   220
#define CURVE_CAPTURE_ERROR_MAX          700
#define CURVE_CAPTURE_DELTA_MAX          350
#define CURVE_CAPTURE_CONFIRM_FRAMES     4U
#define CURVE_INNER_ENTRY_PREDICTED      (-1400)
#define CURVE_INNER_ENTRY_FRAMES         2U
#define CURVE_INNER_EXIT_PREDICTED       (-500)
#define CURVE_INNER_EXIT_FRAMES          2U
#define CURVE_TRACK_MIN_CORR_TICKS       8
#define CURVE_INNER_LEFT_LIMIT_TICKS     18
#define CURVE_DELTA_FILTER_DIVISOR       3
#define CURVE_PREDICTION_FRAMES          2
#define CURVE_CAPTURE_D_DIVISOR          20
#define CURVE_CAPTURE_D_LIMIT            45
#define CURVE_TRACK_D_DIVISOR            30
#define CURVE_TRACK_D_LIMIT              35
#define CURVE_RIGHT_BUILD_STEP           28
#define CURVE_RIGHT_RELEASE_STEP         48
#define CURVE_LEFT_BUILD_STEP            10
#define CURVE_LEFT_RELEASE_STEP          24
#define CURVE_TARGET_ANGLE_MDEG          180000
#define CURVE_EXIT_MIN_ANGLE_MDEG        165000
#define CURVE_REENTRY_CONFIRM_FRAMES     2U
#define CURVE_NO_LINE_MAX_FRAMES         360U
#define GAP_REENTRY_MIN_FRAMES           220U
#define GAP_REENTRY_MAX_FRAMES           600U
#define GAP_REENTRY_CLEAR_FRAMES         8U
#define GAP_SEARCH_START_FRAMES          280U
#define GAP_SEARCH_LEFT_CORR_TICKS       12
#define GAP_SEARCH_SLEW_TICKS            2
#define GRAY_CURVE_ENTRY_ERROR           700
...
volatile uint8_t g_drive_context = DRIVE_CONTEXT_START_BRIDGE;
...
volatile uint8_t g_curve_control_state = CURVE_CONTROL_IDLE;
volatile uint8_t g_curve_capture_confirm_count = 0U;
volatile uint8_t g_curve_inner_entry_confirm_count = 0U;
volatile uint8_t g_curve_inner_exit_confirm_count = 0U;
volatile uint32_t g_curve_inner_recovery_count = 0U;
volatile int32_t g_curve_median_error = 0;
volatile int32_t g_curve_previous_control_error = 0;
volatile int32_t g_curve_error_delta = 0;
volatile int32_t g_curve_filtered_error_delta = 0;
volatile int32_t g_curve_predicted_error = 0;
volatile uint8_t g_curve_predictor_valid = 0U;
volatile int32_t g_curve_derivative_correction = 0;
volatile int32_t g_curve_desired_correction = 0;
volatile int32_t g_curve_applied_correction = 0;
volatile int32_t g_curve_correction_step = 0;
volatile int32_t g_curve_last_valid_total_correction = 0;
volatile int32_t g_curve_lost_hold_initial_correction = 0;
volatile int32_t g_curve_lost_hold_correction = 0;
volatile uint8_t g_curve_lost_hold_active = 0U;
...
volatile int32_t g_curve_right_recovery_correction = 0;
volatile int32_t g_turn_exit_dynamic_counter_correction = 0;
volatile uint8_t g_gap_search_active = 0U;
volatile int32_t g_gap_search_correction = 0;
volatile uint32_t g_gap_rejected_early_line_frames = 0U;
volatile uint32_t g_gap_rejected_early_line_events = 0U;
volatile uint8_t g_gap_early_line_latched = 0U;
volatile uint8_t g_gap_reentry_armed = 0U;
volatile uint8_t g_gap_reentry_clear_count = 0U;
...
static NOINLINE int32_t median_int32(
    int32_t first,
    int32_t second,
    int32_t third)
{
...
{
    int32_t initial_correction = g_total_control_correction;

    if (initial_correction < 0) {
        initial_correction = 0;
    }
    g_curve_active = 1U;
    g_drive_context = DRIVE_CONTEXT_LINE_CURVE;
    ...
    g_curve_right_recovery_correction = 0;
    g_curve_control_state = CURVE_CONTROL_CAPTURE;
    g_curve_capture_confirm_count = 0U;
    g_curve_inner_entry_confirm_count = 0U;
    g_curve_inner_exit_confirm_count = 0U;
    g_curve_median_error = g_gray_line_error;
    g_curve_previous_control_error = g_gray_line_error;
    g_curve_error_delta = 0;
    g_curve_filtered_error_delta = 0;
    g_curve_predicted_error = g_gray_line_error;
    g_curve_predictor_valid = 0U;
    g_curve_derivative_correction = 0;
    g_curve_desired_correction = initial_correction;
    g_curve_applied_correction = initial_correction;
    g_curve_correction_step = 0;
    g_curve_last_valid_total_correction = initial_correction;
    g_curve_lost_hold_initial_correction = 0;
    g_curve_lost_hold_correction = 0;
    g_curve_lost_hold_active = 0U;
    g_turn_exit_dynamic_counter_correction = 0;
    g_gap_search_active = 0U;
    g_gap_search_correction = 0;
    g_gap_early_line_latched = 0U;
    g_gap_reentry_armed = 0U;
    g_gap_reentry_clear_count = 0U;
...
static NOINLINE int32_t curve_apply_progressive_correction(
    int32_t desired_correction)
{
    int32_t current_correction = g_curve_applied_correction;
    int32_t correction_delta = 0;
    int32_t step_limit;

    g_curve_desired_correction = desired_correction;
    if (desired_correction > current_correction) {
        step_limit = (current_correction < 0)
            ? CURVE_LEFT_RELEASE_STEP
            : CURVE_RIGHT_BUILD_STEP;
        correction_delta = clamp_int32(
            desired_correction - current_correction,
            0,
            step_limit);
    } else if (desired_correction < current_correction) {
        step_limit = (current_correction > 0)
            ? CURVE_RIGHT_RELEASE_STEP
            : CURVE_LEFT_BUILD_STEP;
        correction_delta = clamp_int32(
            desired_correction - current_correction,
            -step_limit,
            0);
    ...
    current_correction += correction_delta;
    if (((g_curve_applied_correction < 0) &&
         (current_correction > 0)) ||
        ((g_curve_applied_correction > 0) &&
         (current_correction < 0))) {
        current_correction = 0;
        correction_delta = -g_curve_applied_correction;
    }

    g_curve_correction_step = correction_delta;
    g_curve_applied_correction = current_correction;
    return current_correction;
}

static NOINLINE void curve_update_control_state(
    int32_t error,
    int32_t predicted_error)
{
    if (g_curve_control_state == CURVE_CONTROL_IDLE) {
        g_curve_control_state = CURVE_CONTROL_CAPTURE;
    }

    if (g_curve_control_state == CURVE_CONTROL_INNER_RECOVERY) {
        if (predicted_error >= CURVE_INNER_EXIT_PREDICTED) {
            if (g_curve_inner_exit_confirm_count <
                CURVE_INNER_EXIT_FRAMES) {
                g_curve_inner_exit_confirm_count++;
            }
        } else {
            g_curve_inner_exit_confirm_count = 0U;
        }
        ...
        if (g_curve_inner_exit_confirm_count >=
            CURVE_INNER_EXIT_FRAMES) {
            g_curve_control_state = CURVE_CONTROL_TRACK;
            g_curve_inner_entry_confirm_count = 0U;
            g_curve_inner_exit_confirm_count = 0U;
        }
        return;
    ...
    if (predicted_error <= CURVE_INNER_ENTRY_PREDICTED) {
        if (g_curve_inner_entry_confirm_count <
            CURVE_INNER_ENTRY_FRAMES) {
            g_curve_inner_entry_confirm_count++;
        }
    } else {
        g_curve_inner_entry_confirm_count = 0U;
    }
    ...
    if (g_curve_inner_entry_confirm_count >=
        CURVE_INNER_ENTRY_FRAMES) {
        g_curve_control_state = CURVE_CONTROL_INNER_RECOVERY;
        g_curve_capture_confirm_count = 0U;
        g_curve_inner_exit_confirm_count = 0U;
        g_curve_inner_recovery_count++;
        return;
    }

    if (g_curve_control_state == CURVE_CONTROL_CAPTURE) {
        if ((abs_int32(error) <= CURVE_CAPTURE_ERROR_MAX) &&
            (abs_int32(g_curve_filtered_error_delta) <=
             CURVE_CAPTURE_DELTA_MAX)) {
            if (g_curve_capture_confirm_count <
                CURVE_CAPTURE_CONFIRM_FRAMES) {
                g_curve_capture_confirm_count++;
            }
        } else {
            g_curve_capture_confirm_count = 0U;
        }
...
static NOINLINE int32_t curve_limit_desired_correction(
    int32_t desired_correction,
    int32_t positive_limit)
{
    int32_t negative_limit = CURVE_TRACK_MIN_CORR_TICKS;

    if (g_curve_control_state == CURVE_CONTROL_INNER_RECOVERY) {
        negative_limit = -CURVE_INNER_LEFT_LIMIT_TICKS;
    }
    return clamp_int32(
        desired_correction,
        negative_limit,
...
static NOINLINE void curve_update_entry_without_mpu(void)
{
    ...
    if ((g_gray_line_valid != 0U) &&
        (g_gray_line_error >= GRAY_CURVE_ENTRY_ERROR)) {
...
static NOINLINE void curve_update_reentry(void)
{
    ...
    if (g_gray_line_valid == 0U) {
        g_curve_reentry_confirm_count = 0U;
        if (g_gap_reentry_clear_count < GAP_REENTRY_CLEAR_FRAMES) {
            g_gap_reentry_clear_count++;
        }
        if (g_gap_reentry_clear_count >= GAP_REENTRY_CLEAR_FRAMES) {
            g_gap_reentry_armed = 1U;
        }
        g_gap_early_line_latched = 0U;
        return;
    }
    ...
    if (g_gap_frame_count < GAP_REENTRY_MIN_FRAMES) {
        g_gap_rejected_early_line_frames++;
        if (g_gap_early_line_latched == 0U) {
            g_gap_rejected_early_line_events++;
            g_gap_early_line_latched = 1U;
        }
        g_gap_reentry_armed = 0U;
        g_curve_reentry_confirm_count = 0U;
        return;
...
static NOINLINE void curve_finish(void)
{
    ...
    g_curve_feedforward_correction = 0;
    g_curve_right_recovery_correction = 0;
    g_curve_control_state = CURVE_CONTROL_IDLE;
    g_curve_capture_confirm_count = 0U;
    g_curve_inner_entry_confirm_count = 0U;
    g_curve_inner_exit_confirm_count = 0U;
    g_curve_median_error = 0;
    g_curve_previous_control_error = 0;
    g_curve_error_delta = 0;
    g_curve_filtered_error_delta = 0;
    g_curve_predicted_error = 0;
    g_curve_predictor_valid = 0U;
    g_curve_derivative_correction = 0;
    g_curve_desired_correction = 0;
    g_curve_applied_correction = 0;
    g_curve_correction_step = 0;
    g_curve_last_valid_total_correction = 0;
    g_curve_lost_hold_initial_correction = 0;
    g_curve_lost_hold_correction = 0;
    g_curve_lost_hold_active = 0U;
    g_curve_reentry_confirm_count = 0U;
    ...
    if (had_curve) {
        g_drive_context = DRIVE_CONTEXT_POST_CURVE_GAP;
...
static NOINLINE bool gap_bridge_handle(void)
{
    int32_t desired_correction = 0;
    int32_t correction_delta;
    ...
    if (g_gap_frame_count >= GAP_SEARCH_START_FRAMES) {
        desired_correction = -GAP_SEARCH_LEFT_CORR_TICKS;
    }
    correction_delta = clamp_int32(
        desired_correction - g_gap_search_correction,
        -GAP_SEARCH_SLEW_TICKS,
        GAP_SEARCH_SLEW_TICKS);
    g_gap_search_correction += correction_delta;
    g_gap_search_active = (g_gap_search_correction != 0) ? 1U : 0U;

    g_turn_mode = 7U;
    g_line_correction = 0;
    g_mpu_control_correction = 0;
    g_total_control_correction = g_gap_search_correction;
    set_pwm(
        clamp_pwm(
            (int32_t) POST_CURVE_LEFT_TICKS +
                g_gap_search_correction),
        clamp_pwm(
            (int32_t) POST_CURVE_RIGHT_TICKS -
                g_gap_search_correction));
    return true;
}
...
static NOINLINE bool turn_exit_brake_handle(bool lost_recovery)
{
    ...
    int32_t counter_magnitude;
    int32_t counter_remaining_frames;
    ...
    if (!no_black) {
        ...
        if (g_turn_exit_candidate_direction == 0) {
            ...
            } else if ((g_turn_exit_candidate_direction == 0) &&
                (g_curve_active != 0U) &&
                (g_mpu_link_ok != 0U) &&
                (g_curve_angle_mdeg >= CURVE_EXIT_MIN_ANGLE_MDEG)) {
                g_turn_exit_candidate_direction = -1;
    ...
    g_line_correction = 0;
    g_mpu_control_correction = 0;
    counter_magnitude = clamp_int32(
        g_curve_lost_hold_initial_correction /
            TURN_EXIT_DYNAMIC_COUNTER_DIVISOR,
        0,
        TURN_EXIT_DYNAMIC_COUNTER_LIMIT);
    counter_remaining_frames =
        (int32_t) TURN_EXIT_BRAKE_NO_MPU_FRAMES -
        ((int32_t) g_turn_exit_brake_frame_count - 1);
    if (counter_remaining_frames < 0) {
        counter_remaining_frames = 0;
    }
    counter_target =
        ((int32_t) g_turn_exit_brake_direction * counter_magnitude *
         counter_remaining_frames) /
        (int32_t) TURN_EXIT_BRAKE_NO_MPU_FRAMES;
    g_turn_exit_dynamic_counter_correction =
        curve_apply_progressive_correction(counter_target);
    ...
    if (rate_reached_zero || timed_out) {
        ...
        g_total_control_correction = 0;
        g_turn_exit_dynamic_counter_correction = 0;
        set_pwm(POST_CURVE_LEFT_TICKS, POST_CURVE_RIGHT_TICKS);
    }
    return true;
}
...
static NOINLINE void line_follow_update(void)
{
    bool lost_recovery = (g_gray_line_valid == 0U) ||
        (g_gap_heading_active != 0U);
    bool no_line = (g_gray_line_valid == 0U);
    bool center_locked =
        (!lost_recovery) &&
    ...
    int32_t curve_right_recovery = 0;
    int32_t curve_derivative = 0;
    int32_t sharp_correction_limit = LINE_SHARP_CORR_LIMIT;
    int32_t normal_negative_limit =
        LINE_CORR_LIMIT + GYRO_TOTAL_CORR_LIMIT;
    int32_t normal_positive_limit = normal_negative_limit;
    int32_t error = lost_recovery
        ? (int32_t) g_line_last_nonzero_error
        : (int32_t) g_gray_line_error;
    int32_t left_base = (g_drive_context ==
        DRIVE_CONTEXT_POST_CURVE_GAP)
        ? (int32_t) POST_CURVE_LEFT_TICKS
        : (int32_t) PWM_LEFT_BASE_TICKS;
    int32_t right_base = (g_drive_context ==
        DRIVE_CONTEXT_POST_CURVE_GAP)
        ? (int32_t) POST_CURVE_RIGHT_TICKS
        : (int32_t) PWM_RIGHT_BASE_TICKS;
    bool sharp_turn;

    if (gap_bridge_handle()) {
        return;
    }

    if ((g_curve_active != 0U) && !lost_recovery) {
        uint8_t previous_control_state = g_curve_control_state;
        bool predictor_was_valid = (g_curve_predictor_valid != 0U);
        int32_t raw_error_delta;

        error = median_int32(
            g_line_error_history_0,
            g_line_error_history_1,
            g_line_error_history_2);
        g_curve_median_error = error;
        if (!predictor_was_valid) {
            raw_error_delta = 0;
            g_curve_error_delta = 0;
            g_curve_filtered_error_delta = 0;
            g_curve_predicted_error = error;
            g_curve_predictor_valid = 1U;
        } else {
            raw_error_delta = error - g_curve_previous_control_error;
            g_curve_error_delta = raw_error_delta;
            g_curve_filtered_error_delta =
                (((CURVE_DELTA_FILTER_DIVISOR - 1) *
                  g_curve_filtered_error_delta) + raw_error_delta) /
                CURVE_DELTA_FILTER_DIVISOR;
            g_curve_predicted_error = error +
                CURVE_PREDICTION_FRAMES *
                    g_curve_filtered_error_delta;
        }
        curve_update_control_state(error, g_curve_predicted_error);
        if (predictor_was_valid &&
            (g_curve_control_state == previous_control_state) &&
            (g_curve_control_state == CURVE_CONTROL_CAPTURE)) {
            curve_derivative = clamp_int32(
                g_curve_filtered_error_delta /
                    CURVE_CAPTURE_D_DIVISOR,
                -CURVE_CAPTURE_D_LIMIT,
                CURVE_CAPTURE_D_LIMIT);
        } else if (predictor_was_valid &&
            (g_curve_control_state == previous_control_state) &&
            (g_curve_control_state == CURVE_CONTROL_TRACK)) {
            curve_derivative = clamp_int32(
                g_curve_filtered_error_delta /
                    CURVE_TRACK_D_DIVISOR,
                -CURVE_TRACK_D_LIMIT,
                CURVE_TRACK_D_LIMIT);
        }
        g_curve_derivative_correction = curve_derivative;
        g_curve_previous_control_error = error;
    } else {
        g_curve_error_delta = 0;
        g_curve_filtered_error_delta = 0;
        g_curve_predicted_error = 0;
    ...
    if (!no_line) {
        g_curve_lost_hold_initial_correction = 0;
        g_curve_lost_hold_correction = 0;
    } else if (((g_curve_active != 0U) ||
        (mask_is_right_exit(g_line_mask_history_1) &&
         mask_is_right_exit(g_line_mask_history_2))) &&
        (g_line_lost_count < TURN_EXIT_CONFIRM_LOST_FRAMES)) {
        int32_t release_frames;

        if (g_line_lost_count <= 1U) {
            g_curve_lost_hold_initial_correction = clamp_int32(
                g_curve_last_valid_total_correction,
                0,
                CURVE_RIGHT_LOST_HOLD_MAX_CORR);
        }
        release_frames = (int32_t) TURN_EXIT_CONFIRM_LOST_FRAMES -
            (int32_t) g_line_lost_count;
        g_curve_lost_hold_correction =
            (g_curve_lost_hold_initial_correction * release_frames) /
            ((int32_t) TURN_EXIT_CONFIRM_LOST_FRAMES - 1);
        g_curve_lost_hold_active = 1U;
    }
    ...
    if ((g_curve_active != 0U) && !lost_recovery &&
        (error > CURVE_RIGHT_RECOVERY_ERROR_MIN)) {
        curve_right_recovery = clamp_int32(
            (error - CURVE_RIGHT_RECOVERY_ERROR_MIN) /
                CURVE_RIGHT_RECOVERY_DIVISOR,
            0,
            CURVE_RIGHT_RECOVERY_CORR_LIMIT);
        normal_positive_limit += CURVE_RIGHT_RECOVERY_CORR_LIMIT;
    }
    g_curve_right_recovery_correction = curve_right_recovery;
    ...
    if (g_curve_lost_hold_active != 0U) {
        g_turn_mode = 6U;
        g_turn_was_active = 1U;
        g_line_correction = g_curve_lost_hold_correction;
        g_gyro_rate_correction = 0;
        g_gyro_heading_correction = 0;
        g_mpu_control_correction = 0;
        g_total_control_correction = g_curve_lost_hold_correction;
        g_curve_correction_step =
            g_total_control_correction - g_curve_applied_correction;
        g_curve_desired_correction = g_total_control_correction;
        g_curve_applied_correction = g_total_control_correction;
        set_pwm(
    ...
    if (g_gray_changed_count != 0U) {
        g_turn_exit_left_nudge_active = 0U;
        g_turn_exit_left_nudge_remaining = 0U;
    } else if ((TURN_EXIT_LEFT_NUDGE_ENABLE != 0U) &&
    ...
    if (lost_recovery && (error == 0)) {
        g_line_correction = 0;
        g_total_control_correction =
            curve_feedforward + curve_right_recovery + gyro_correction;
        set_pwm(
            clamp_pwm(
                left_base + g_total_control_correction),
            clamp_pwm(
                right_base - g_total_control_correction));
        return;
    }
    ...
    if (sharp_turn) {
        g_line_correction = clamp_int32(
            ...
            sharp_correction_limit);
        g_total_control_correction =
            g_line_correction + curve_feedforward +
                curve_right_recovery + curve_derivative +
                gyro_correction;
        if ((g_curve_active != 0U) && !lost_recovery) {
            int32_t curve_positive_limit =
            ...
            g_total_control_correction =
                curve_limit_desired_correction(
                    g_total_control_correction,
                    curve_positive_limit);
            g_total_control_correction =
                curve_apply_progressive_correction(
                    g_total_control_correction);
            g_curve_last_valid_total_correction =
                g_total_control_correction;
        }
    ...
    g_total_control_correction = clamp_int32(
        g_line_correction + curve_feedforward +
            curve_right_recovery + curve_derivative +
            gyro_correction,
        -normal_negative_limit,
        normal_positive_limit);
    if ((g_curve_active != 0U) && !lost_recovery) {
        g_total_control_correction =
            curve_limit_desired_correction(
                g_total_control_correction,
...
int main(void)
{
    ...
    g_drive_context = DRIVE_CONTEXT_START_BRIDGE;
    ...
    g_gap_search_active = 0U;
    g_gap_search_correction = 0;
    g_gap_rejected_early_line_frames = 0U;
    g_gap_rejected_early_line_events = 0U;
    g_gap_early_line_latched = 0U;
    g_gap_reentry_armed = 0U;
    g_gap_reentry_clear_count = 0U;
    g_start_bridge_left_cmd_ticks = clamp_pwm(
        START_BOOST_BASE_TICKS + START_BOOST_TRIM_TICKS);
    ...
    for (g_run_frame = 0U; g_run_frame < RUN_MAX_FRAMES; g_run_frame++) {
        ...
        if (g_phase == PHASE_START_BRIDGE) {
            ...
            if (g_start_bridge_frame_count <= START_BOOST_FRAMES) {
                ...
                bridge_left_base =
                    START_BRIDGE_BASE_TICKS + START_BRIDGE_TRIM_TICKS;
                bridge_right_base =
                    START_BRIDGE_BASE_TICKS - START_BRIDGE_TRIM_TICKS;
            }
